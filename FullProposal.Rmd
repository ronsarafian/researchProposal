...
Back to the simple LME model presented in (\ref{eq:mixedm}). Remember that $j$ now represent a cluster (e.g., a day cluster) and $s_j$ is the number of observations in it (e.g., the number of spatial replications per day). The mixed effect model assume normal disttribution of the error, specificaly:
