...
\begin{titlepage}
    ...
    \vfill
    \normalsize
    \begin{tabular}{b{11cm} r}
      Advisor: Dr. Johnathan Rosenblatt & \underline{\hspace{3cm}} \\ \\
      Advisor: Prof. Itai Kloog & \underline{\hspace{3cm}} \\ \\
      Advisor: Prof. Israel Parmet & \underline{\hspace{3cm}} \\ \\
      Chairman of Ph.D. students committee (IEM Department): 
        Prof. Joseph Kreimer & \underline{\hspace{3cm}} \\
    \end{tabular}
\end{titlepage}
